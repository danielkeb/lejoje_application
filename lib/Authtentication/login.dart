...
import 'package:lejoje/Authtentication/signup.dart';
...
class _LoginScreenState extends State<LoginScreen> {
 ...
 login() async {
  var response = await db.login(Users(usrName: username.text,phoneNumber: phonenumber.text ,usrPassword: password.text));
  if (response == true) {
    // If login is correct, then show success snack message
    ...
    // If login fails, show error snack message
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
    ...
    // Set the bool value to show error message
    setState(() {
      isLoginTrue = true;
    });
  }
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset(
                    "lib/assets/cross_silhouette-removebg-preview.png",
                    width: 210,
                  ),
